...
function c2150005.t(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return e:GetHandler():GetTurnID()==Duel.GetTurnCount() and Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_DECK,0,1,nil,0x215) and h:IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,h,1,tp,LOCATION_GRAVE)
end
function c2150005.f(c)
	return c:IsSetCard(0x215) and not c:IsCode(2150005) end
end
